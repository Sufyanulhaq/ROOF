...
<div class="body_content">
    ...
    <h1>What is Square (in Roofing)?</h1>
    <a href="{{url('/roof/def')}}">More roofing definitions</a><br>
    <p>
        One "square" is equal to 100 square feet, and is the typical unit of measurement used to describe roofing
        materials.  For example, if your roof measured 30 feet by 40 feet, you would need 1200 square feet 
        (12 "squares") of shingles.
    </p>
    <p>
        Shingles are packaged in bundles, and there are usually between 3 and 5 bundles per square.
    </p>
